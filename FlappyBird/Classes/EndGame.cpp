...
bool EndGame::init()
{
    ...
    auto closeItem = MenuItemImage::create(
                                           "CloseNormal.png",
                                           "CloseSelected.png",
                                           CC_CALLBACK_1(EndGame::menuCloseCallback, this));
    ...
    auto play = MenuItemLabel::create(Label::createWithTTF("Game Over", "fonts/Marker Felt.ttf", 40), CC_CALLBACK_1(EndGame::play, this));
